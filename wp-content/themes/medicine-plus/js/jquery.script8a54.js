...
jQuery(document).ready(function() { 
	...
	(function ($) { 
		if ( 
				...
				$(this).find('.cmsms_stat').each(function () { 
					...
					setTimeout(function () { 
						el.easyPieChart( { 
							...
							trackColor : 	false, 
							barColor : function () { 
								return ($(this.el).data('bar-color')) ? $(this.el).data('bar-color') : '#65c5e4';
							}, 
			...
			$('.cmsms_stats.stats_mode_circles').find('.cmsms_stat').easyPieChart( { 
				...
				trackColor : 	false, 
				barColor : function () { 
					return ($(this.el).data('bar-color')) ? $(this.el).data('bar-color') : '#d3383f';
				}, 
				onStep : function (from, to, val) { 
					$(this.el).find('.cmsms_stat_counter').text(~~val);
				} 
	...
	/* Header Search Toggle */
	(function ($) { 
		$('#header .header_bot .search_but').bind('click', function () { 
			var searchWrap = $(this).parents('.header_bot .search_wrap');
			...
			var searchWrap = $(this).parents('#header');
			
			
			if (searchWrap.hasClass('header_bottom_search_opened')) {
				searchWrap.removeClass('header_bottom_search_opened');
			} else {
				searchWrap.addClass('header_bottom_search_opened');
			}
		} );
	} )(jQuery);
